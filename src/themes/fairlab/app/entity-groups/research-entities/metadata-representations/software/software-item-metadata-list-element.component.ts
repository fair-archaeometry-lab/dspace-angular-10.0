...
@Component({
    selector: 'ds-software-item-metadata-list-element',
    templateUrl: './software-item-metadata-list-element.component.html',
    imports: [
        NgbTooltip,
        RouterLink,
...
export class SoftwareItemMetadataListElementComponent
