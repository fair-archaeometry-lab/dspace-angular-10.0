...
@listableObjectComponent('Instrument', ViewMode.StandalonePage, Context.Any, 'fairlab')
@Component({
    selector: 'ds-fairlab-instrument',
...
export class InstrumentComponent extends ItemComponent {
}