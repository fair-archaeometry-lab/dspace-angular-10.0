...
@listableObjectComponent('Software', ViewMode.StandalonePage, Context.Any, 'fairlab')
@Component({
    selector: 'ds-fairlab-software',
...
export class SoftwareComponent extends ItemComponent {
}