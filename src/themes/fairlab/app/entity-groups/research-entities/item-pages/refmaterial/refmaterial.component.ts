...
@listableObjectComponent('ReferenceMaterial', ViewMode.StandalonePage, Context.Any, 'fairlab')
@Component({
    selector: 'ds-fairlab-refmaterial',
    styleUrls: ['./refmaterial.component.scss'],
    templateUrl: './refmaterial.component.html',
...
export class RefmaterialComponent extends ItemComponent {
}