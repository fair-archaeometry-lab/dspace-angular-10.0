...
@listableObjectComponent('StandardMethod', ViewMode.StandalonePage, Context.Any, 'fairlab')
@Component({
    selector: 'ds-fairlab-method',
...
export class MethodComponent extends ItemComponent {
}